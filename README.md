...
This repository documents my research contributions during my Winter Internship at the National Astronomical Observatory of Japan (NAOJ).
The project focused on reconstructing Gamma-Ray Burst (GRB) X-ray afterglow light curves using:
...
The aim was to improve reconstruction fidelity and extract key astrophysical parameters such as:
...
This work also contributes to a larger cosmology-oriented effort to evaluate GRBs as potential standardizable candles for high-redshift universe expansion studies.
...
Multi-model framework for reconstructing GRB light curves using machine and deep-learning approaches.
This includes models closely related to my LSTM / Bi-LSTM pipeline designs.

2. Dainotti et al. (2023) – ApJS 267, 42

https://ui.adsabs.harvard.edu/abs/2023ApJS..267...42D/abstract
...
Performed trimming, cleaning, normalization, time-binning, and multi-epoch comparison.
...
The full detailed report, code summaries, and model comparisons are included in the /report/ directory (placeholder added for now).

🤝 Acknowledgements

I sincerely thank Prof. Maria Giovanna Dainotti for her guidance, mentorship, and support throughout this project.
Her expertise in GRB astrophysics and machine learning made this internship a transformative learning experience for me.
